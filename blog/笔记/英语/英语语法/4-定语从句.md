...
1. 限定性定语从句
    ...
    * He is not such a man as I thought he was. 他并非我所想的那样的人. (I thought he was as)
    
2. 非限定性定语从句
   
   **先行词为句子时，定语从句可用as(作主语、表语、宾语)引导。**

    * As we all know, China is a developing country. (as作宾语)
...
|    区分    |                      定语从句                       |                          同位语从句                           |
| --------- | --------------------------------------------------- | ------------------------------------------------------------ |
| 句法作用(通过这个很难判断)   | 对先行词进行修饰和限定                                | 对修饰对象进行解释说明，具体阐述其内容                          |
| 从句引导词 | 1)that在从句中作成分 2)从句不能用what/whether/how引导 | 1)that在从句中不作任何成分。 2)从句可以用what/whether/how引导。 |

1. The news that you told me is really shocking. 你告诉我的那个消息太令人震惊了（定语从句）
2. The news that our team has won is exciting. 我们的队伍获胜了这一消息令人兴奋。（同位语从句）